...
int main() {
    ...
    test_sort(quick_sort, array1, size);
    test_sort(quick_sort, array2, 2*size);

    /*---------- Merge Sort ----------*/
    printf("\nMerge Sort:\n");

    test_sort(merge_sort, array1, size);
    test_sort(merge_sort, array2, 2*size);

    /*---------- Bubble Sort ----------*/
    printf("\nBubble Sort:\n");

    test_sort(bubble_sort, array1, size);
    test_sort(bubble_sort, array2, 2*size);

    /*---------- Selection Sort ----------*/
    printf("\nSelection Sort:\n");

    test_sort(selection_sort, array1, size);
    test_sort(selection_sort, array2, 2*size);

    /*---------- Insertion Sort ----------*/
    printf("\nInsertion Sort:\n");

    test_sort(insertion_sort, array1, size);
    test_sort(insertion_sort, array2, 2*size);
}
